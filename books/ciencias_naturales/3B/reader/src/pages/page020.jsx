                ...
                <div className={"page " + background + " position-relative pagina-cohete"} id={"page_" + pagina}>
                    ...
                    <div className="w-100 mt-15 pe-5 ps-5 ">
                                    ...
                                    <div className={"d-flex " + bgc_cajas + " psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 pc-caja-outline-e" + etapa}>
                                        ...
                                        <div>
                                            <span className="fsp-16 text-start f-pixilate-regular">
                                                <span className="fsp-16 f-IntroRustG-Base text-start">INVESTIGAR </span>
                                                sobre los <br /> tipos de desechos y su destino.
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className={"d-flex " + bgc_cajas + " psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 pc-caja-outline-e" + etapa}>
                                        ...
                                        <div className="d-flex">
                                            <span className="fsp-16 text-start f-pixilate-regular">
                                                ...
                                                acciones<br /> relacionadas a las 3R.
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className={"d-flex " + bgc_cajas + " psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 pc-caja-outline-e" + etapa}>
                                        ...
                                        <div className="d-flex">
                                            <span className="fsp-16 text-start f-pixilate-regular">
                                                ...
                                                sobre lo <br /> investigado y cómo se utilizará <br />para cumplir con el desafío.
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex justify-content-center mtp--10 mbp-50 ">
                            <div className="">
                                <img src={"images/page_" + pagina + "/imagen2.jpg"} className="w-100" alt="" />
                            </div>
                        </div>
                        {/* Begin pie de página */}
