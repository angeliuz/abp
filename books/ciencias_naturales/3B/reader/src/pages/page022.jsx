        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="ptp-30 container-titulo-global mbp-40">
            ...
            <div className="d-flex">
              ...
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"68"} image={"images/page_" + pagina + "/revista.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
            </div>
          </div>
          ...
          <div className="row container-row m-0 psp-60 pep-60">
            ...
            <div className="col-md-12 col-lg-12 position-relative ptp-40">
              ...
              <div className="d-flex flex-column pbp-30 w-100 bgc-woody p-2 rounded-p-20 position-relative mbp-70">
                <div className="position-absolute top-0 start-50 translate-middle msp-0 mtp-5 visible-768"><img src={"images/page_" + pagina + "/espiral2.png"} className="wp-550 " alt="" /></div>
