          ...
          <div className="d-flex global-margin mtp-0 mbp-0 psp-0 pep-0 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
              <div className="col-12 p-0 m-0 position-relative d-flex center-center">
                ...
                <div className="position-absolute top-100 start-50 translate-middle msp-230 mtp--110 zindex-2 visible-768"><img src={"images/page_" + pagina + "/img_002.png"} className="wp-150" alt="" /></div>
                  ...
                  <div className="col-12 p-0 m-0">
                    <div className="d-flex flex-column">
                      ...
                      <div className="d-flex w-100 psp-20 pep-10 ptp-0 pbp-0">
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="w-100 p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-80 max-wp-650" />
                      </div>
                    </div>
                  </div>
                  <div className="col-12 p-0 m-0">
