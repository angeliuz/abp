                    ...
                    <div className="ptp-30 container-titulo-global mbp-20">
                        ...
                        <div className="d-flex">
                            ...
                            <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                                Leo la información en la revista. Luego, contesto las preguntas.
                            </div>
                            {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/generales/play.svg" clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
                            {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
                            {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
                            <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"73"} image={"images/page_" + pagina + "/img_002.jpg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
                        </div>
                    </div>
                        ...
                        <div className="row w-100 p-0 m-0">
                            ...
                            <div className="col-sm-12 col-md-12 position-relative">
                                <div className="d-flex f-Ubuntu-R fsp-20 psp-10 pep-10 mtp-20 text-start">
                                    ...
                                    <div className="f-Ubuntu-R fsp-16 color-dark f-Ubuntu-B w-100 ">¿Qué aporta la institución a la sociedad? ¿A quiénes beneficia?</div>
                            ...
                            <div className="col-sm-12 col-md-12 position-relative">
                                <div className="d-flex f-Ubuntu-R fsp-20 psp-10 pep-10 mtp-20 text-start">
                                    ...
                                    <div className="f-Ubuntu-R fsp-16 color-dark f-Ubuntu-B w-100 ">¿Quiénes trabajan en ella?</div>
                            ...
                            <div className="col-sm-12 col-md-12 position-relative">
                                <div className="d-flex f-Ubuntu-R fsp-20 psp-10 pep-10 mtp-20 text-start">
                                    ...
                                    <div className="f-Ubuntu-R fsp-16 color-dark f-Ubuntu-B w-100 ">¿A qué tipo de institución corresponde?</div>

                                </div>
                                <div className="d-flex justify-content-center mtp-20">

                                    <div className="d-flex psp-20 pep-20 ptp-20 pbp-20 f-Ubuntu-L fsp-18 box-shadow-simple bgc-kano rounded-p-10">
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="psp-10 ptp-0">Pública</div>
                                        </div>
                                        <div className="d-flex">
                                            <div className="ptp-0 psp-10">

                                                <Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check>

                                            </div>
                                            <div className="psp-10 ptp-0">Privada</div>
                                        </div>
