                ...
                <div className="d-flex psp-60 pep-60 mbp-70">
                  <div className="row w-100">
                    ...
                    <div className="col-12 col-md-6 position-relative">
                            ...
                            <div className="position-absolute top-0 start-100 translate-middle msp-0 mtp--70 visible-768"><img src="images/page_013/personaje.png" className="wp-150 " alt="" /></div>
