      ...
      <div className="d-flex flex-column align-items-center pbp-20">
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="ptp-30 container-titulo-global mbp-20">
            <div className={"f-Ubuntu-B fsp-20 psp-0 text-start lhp-20 " + color}>¿Qué ocurre con los desechos?</div>
          ...
          <div className="d-flex psp-60 pep-60 mbp-70">
            <div className="row w-100">
              ...
              <div className="col-12 col-md-6 position-relative">
                <div className="position-absolute top-0 start-100 translate-middle msp--80 mtp--70 visible-768"><img src="images/page_013/personaje.png" className="wp-150 " alt="" /></div>
                <img src="images/page_013/imagen.png" className="w-100 mtp--30" alt="" />
              </div>
              <div className="col-12 col-md-12 ptp-20 position-relative">
