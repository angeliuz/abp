        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          xxx
            ...
            <div className="d-flex psp-20">
              ...
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/generales/play.svg"} clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/page_"+pagina+"/img_001.png"} className="p-0 px-1" /> */}
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"75"} image={"images/page_" + pagina + "/img_003.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
            </div>
          </div>
          ...
          <div className="d-flex global-margin mtp-20 mbp-100 psp-0 pep-0 ptp-0 pbp-0 bgc-ryu rounded-p-10">
            <div className="row p-0 m-0 w-100 f-Ubuntu-R fsp-15">
              ...
              <div className="col-sm-4 col-md-4 p-0 m-0 position-relative ">
                ...
                <div className="d-flex center-center p-2 rounded-p-20 min-hp-160 bgc-white">
                <SubirImagen
