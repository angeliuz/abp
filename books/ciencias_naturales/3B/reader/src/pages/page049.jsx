    ...
    <div className="wrapper bgc-light">
      <div className="d-flex flex-column align-items-center pbp-20">
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="d-flex global-margin mtp-0 mbp-0 psp-20 pep-20 ptp-20 pbp-20 bgc-buzz rounded-p-10">
            <div className="row p-0 m-0 w-100 bgc-red">
              <div className="col-auto p-0 m-0 position-relative d-flex justify-content-end align-items-center bgc-blue">
                <div className="bgc-bulma color-white f-Ubuntu-B fsp-15 psp-10 pep-10 ptp-10 pbp-10 mep-10 min-hp-40 rounded-p-10 min-hp-50 d-flex center-center">Construir el modelo.</div>
              </div>
              <div className="col p-0 m-0 position-relative d-flex center-center bgc-yellow">
