            ...
            <div className="ptp-10 container-titulo-global mbp-20">
              ...
              {/* <div className={"f-Ubuntu-B fsp-20 psp-40 text-start lhp-20 "+color}>¡Tantos desechos!</div> */}
                <div className="d-flex psp-40 w-90">
                    ...
                    {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
                    {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
                    <ModalBook id={ "p" + pagina + "_book"+ (indexInput+=1) } image="images/page_010/img_006.png" clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
                </div>
              </div>     


            <div className="d-flex psp-90 pep-90 mtp-30">
