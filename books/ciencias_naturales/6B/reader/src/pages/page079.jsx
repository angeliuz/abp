                    ...
                    <div className="row m-0 p-2 w-100 ">
                                              ...
                                              <table className="w-100">
                                                  <tbody>
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td className="bgc-white border-style-solid border-1 border-color-bulma"></td>
                                                          <td className="bgc-white border-style-solid border-1 border-color-bulma"></td>
                                                          <td className="bgc-white border-style-solid border-1 border-color-bulma"></td>
                                                          <td className="bgc-white border-style-solid border-1 border-color-bulma"></td>
                                                      </tr>
                        ...
                        <div className="position-absolute top-100 start-0 translate-middle wp-100 msp-20 mtp--30"><img src="images/page_079/img_007.png" className="wp-60" /></div>
                            ...
                            <div className="box-color-24-1">
                                <div className="f-Ubuntu-B alinea rounded-set-10 bgc-android18 w-100 p-2 text-center color-white">¿Qué ejemplo o caso de<br /> discriminación conoces?</div>
                        ...
                        <div className="col-sm-12 col-md-6 position-relative">
                            ...
                            <div className="f-Ubuntu-B alinea rounded-set-10 bgc-pidgey w-100 p-2 text-center color-white">¿Por qué condición o característica<br /> se discriminó en dicho caso?</div>
