              ...
              <div className="container-titulo-global mbp-0 mbp-20">
                <div className="d-flex psp-20">
                  ...
                  <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                    Leemos los consejos de la revista y, antes de presentarnos a
                    toda comunidad educativa, ensayamos lo que diremos frente a
                    nuestro curso.
                  </div>
                  {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/generales/play.svg"} clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
                  {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/page_"+pagina+"/img_001.png"} className="p-0 px-1" /> */}
                  <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"96"} image={"images/page_" + pagina + "/img_001.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
                </div>
              </div>
              <div className="bgc-riuko ptp-10 pbp-40 rounded-p-10 mbp-70">
                ...
                <div className="row mx-auto d-flex f-Ubuntu-R fsp-15 mbp-70 ">
                  <div className="col-sm-12 col-md-6 position-relative">
                    <div className="position-absolute top-100 start-0 translate-middle msp-0 mtp-0 visible-768 zindex-10">
                      <img
                  ...
                  <div className="col-sm-12 col-md-6 position-relative">
                    <div className="position-absolute top-100 start-100 translate-middle msp--60 mtp-20 visible-768 zindex-10">
                      <img
                ...
                <div className="max-wp-600 mx-auto position-relative">
                  <div className="position-absolute top-100 start-0 translate-middle msp-0 mtp--70 visible-768 zindex-10">
                    <img
