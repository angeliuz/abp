                        ...
                        <div className="row d-flex mx-auto f-Ubuntu-B fsp-15 mbp-0 position-relative justify-content-between">
                            ...
                            <div className="col-sm-12 col-md-6 pbp-10">
                                <div className="text-center w-100 border-1 border-style-solid border-color-saitama rounded-p-10">
                                    <div className="rounded-set-6 hp-60 pep-20 psp-20 ptp-10 pbp-10 bgc-saitama d-flex justify-content-center align-items-center text-white p-2">¿Por qué es una solución<br/>
                            ...
                            <div className="col-sm-12 col-md-6 pbp-10">
                                <div className="text-center w-100 border-1 border-style-solid border-color-bulma rounded-p-10">
                                    <div className="rounded-set-6 hp-60 ptp-10 pbp-10 bgc-bulma d-flex justify-content-center align-items-center text-white p-2">¿En qué otros lugares se podría<br/> replicar esta solución?</div>
                                    <div className="psp-15 pep-15"><InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-175" /></div>
                                </div>
                            </div>
                        </div>
