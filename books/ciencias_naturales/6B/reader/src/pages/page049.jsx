          ...
          <div className="d-flex global-margin mtp-10 mbp-10 psp-50 pep-20 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
              <div className="col-4 p-1 m-0">
                ...
                <div className=" wp-25 hp-25 mx-auto"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check></div>
              </div>
              <div className="col-4 p-1 m-0">
              ...
              <div className="col-4 p-1 mtp-10 rounded-p-20 bgc-white border-style-solid border-color-dark border-1">
                <SubirImagen
                  id={"imagen_" + pagina + "_" + (indexInput += 1)}
                  className="w-100 bgc-white h-100 "
