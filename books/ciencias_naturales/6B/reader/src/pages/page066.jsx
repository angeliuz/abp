            ...
            <div className="row p-0 msp-0 w-100">
              <div className="col-12 p-0 m-0 position-relative">
                ...
                <div className="d-flex w-100 p-2">
                  ...
                  <div className="d-flex justify-content-start align-items-center text-start f-Ubuntu-R fsp-15 ptp-0 pbp-3 psp-5">
                    Leo la revista y escribo textos llamativos para incluir en las invitaciones
                  </div>
                  <img src={"images/page_" + pagina + "/img_001.svg"} className="wp-50 msp-30" alt="" />
                </div>
                  ...
                  <div className="col-6 m-0 p-2">
                    <div className="d-flex justify-content-center  w-100  p-3">
                      <div className="bgc-shogun wp-320 p-2 sombra-paralela-left  position-relative">
                        <div className="position-absolute top-0 start-50 translate-middle   msp--100 mtp-10 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip01.svg"} className="wp-20" alt="" /></div>
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 mtp-10 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-180" />
                      </div>
                    </div>
                    <div className="d-flex justify-content-center  w-100  p-3">
                      <div className="bgc-reptile wp-320 p-2  reptile sombra-paralela-left  position-relative">
                        <div className="position-absolute top-0 start-50 translate-middle   msp--100 mtp-10 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip03.svg"} className="wp-20" alt="" /></div>
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 mtp-10 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-180" />
                      </div>
                    </div>
                    <div className="d-flex justify-content-center  w-100  p-3">
                      <div className="bgc-hansolo wp-320 p-2 sombra-paralela-left  position-relative">
                        <div className="position-absolute top-0 start-50 translate-middle   msp--100 mtp-10 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip05.svg"} className="wp-20" alt="" /></div>
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 mtp-10 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-180" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-6 m-0 p-2">
                    <div className="d-flex justify-content-center  w-100  p-3">
                      <div className="bgc-blanka wp-320 p-2 sombra-paralela-left  position-relative">
                        <div className="position-absolute top-0 start-50 translate-middle   msp--100 mtp-10 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip02.svg"} className="wp-20" alt="" /></div>
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 mtp-10 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-180" />
                      </div>
                    </div>
                    <div className="d-flex justify-content-center  w-100  p-3">
                      <div className="bgc-bobafett wp-320 p-2 sombra-paralela-left  position-relative">
                        <div className="position-absolute top-0 start-50 translate-middle   msp--100 mtp-10 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip04.svg"} className="wp-20" alt="" /></div>
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 mtp-10 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-180" />
                      </div>
                    </div>
                    <div className="d-flex justify-content-center  w-100  p-3">
                      <div className="bgc-urien wp-320 p-2 sombra-paralela-left  position-relative">
                        <div className="position-absolute top-0 start-50 translate-middle   msp--100 mtp-10 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip06.svg"} className="wp-20" alt="" /></div>
                        <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 mtp-10 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-180" />
                      </div>
                    </div>
                  </div>
