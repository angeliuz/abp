    ...
    <div className="wrapper bgc-light">
          ...
          <div className="container-titulo-global mbp-20">
                <div className="d-flex">
                    ...
                    <ModalBook id={ "p" + pagina + "_book"+ (indexInput+=1) } image="images/page_027/img_001.svg" clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
                </div>
            </div> 
            <div className="d-flex">
            ...
            <div className="row container-row px-5">
                ...
                <div className="col-12 justify-content-center mtp-10 mbp-70 psp-80 pep-80 pbp-50 position-relative">
                    <div className="position-absolute top-50 start-0 translate-middle msp-40 mtp-25 visible-768"><img src="images/page_027/img_001.png" className="wp-40 " alt="" /></div>
