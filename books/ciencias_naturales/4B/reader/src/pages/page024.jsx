        ...
        <div className={"page " + background + " position-relative pagina-cohete"} id={"page_" + pagina}>
          ...
          <div className="w-100 mt-15 pe-5 ps-5 ">
              ...
              <div className="pc-caja-objetivos-1">
                <div className="color-hardDark fsp-16 lh-sm f-pixilate-regular text-start">
                  <div className={"d-flex " + bgc_cajas + " psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 pc-caja-outline-e" + etapa}>
                    <div className="d-flex align-items-start wp-23">
                    ...
                    <div className="d-flex">
                      <span className="fsp-16 f-IntroRustG-Base text-start">
                        INVESTIGAR <span className="fsp-16 text-start f-pixilate-regular">
                          los riesgos<br /> naturales y situaciones de<br /> emergencia a los que estamos expuestos.
                        </span>
                      </span>
                    </div>
                  </div>
                  ...
                  <div className={"d-flex " + bgc_cajas + " psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 pc-caja-outline-e" + etapa}>
                    ...
                    <div className="d-flex">
                      <span className="fsp-16 text-start f-pixilate-regular">
                        <span className="fsp-16 f-IntroRustG-Base text-start">ANALIZAR </span>
                        el plan de <br /> seguridad del colegio y encuestar <br />a la comunidad educativa para <br /> saber cuánto lo conoce.
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="pc-caja-objetivos-3">
                <div className="color-hardDark fsp-16 lh-sm f-pixilate-regular text-start">
                  <div className={"d-flex " + bgc_cajas + " psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 pc-caja-outline-e" + etapa}>
                    ...
                    <div className="d-flex">
                      <span className="fsp-16 text-start f-pixilate-regular">
                        <span className="fsp-16 f-IntroRustG-Base text-start">RESUMIR </span>
                        lo investigado <br /> en fichas de seguridad.
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="d-flex hp-90 caja-flotante p-0 m-0 position-absolute justify-content-end align-items-end zindex-2" style={{ bottom: 70, right: 0 }}>
              <div className="f-Ubuntu-M fsp-10 position-absolute mbp-60 bgc-white" style={{ transform: `rotate(270deg)`, color: "dark" }}>
                ABP &copy; SM
              </div>
