          ...
          <div className="container-titulo-global mbp-∫0 cb-600">
            ...
            <div className="cb-700 mx-auto p-2 f-Ubuntu-L bgc-white fsp-13 rounded-p-10 ps-4 pe-4 mbp-20">
              <div className="flex-wrap w-100 text-start">
                <img src="images/page_064/flecha.svg" className="hp-10 pep-5 mtp-5"/>
                <span className="w-24 f-Ubuntu-L fsp-15">Las tareas en las que más me gusta participar son: </span>
              ...
              <div className="flex-wrap w-100 text-start mtp-10">
                <img src="images/page_064/flecha.svg" className="hp-10 pep-5 mtp-5"/>
                <span className="w-24 f-Ubuntu-L fsp-15">Me resulta más difícil llegar a acuerdos cuando: </span>
                <div className="pep-10 psp-10">
                  <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-70"/>
                </div>
              </div>
              <div className="flex-wrap w-100 text-start mtp-10">
                <img src="images/page_064/flecha.svg" className="hp-10 pep-5 mtp-5"/>
                <span className="w-24 f-Ubuntu-L fsp-15">¿Quién me ha ayudado y se lo voy a agradecer? </span>
                <div className="pep-10 psp-10">
                  <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-70"/>
                </div>
              </div>
            ...
            {/* TABLA */}
            <div className="cb-700 mx-auto mbp-30">
