          ...
          <div className="page bgc-white overflow-hidden position-relative" id={"page_"+pagina}>
              ...
              <div className="ptp-10 psp-100 pep-60 mbp-0">
                <div className="d-flex">
                  ...
                  <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 text-start w-75">Con mi equipo, evaluamos la presentación del simulacro y la reacción de la brigada.</div>
                </div>
              </div>

              <div className="ptp-10 psp-110 pep-80 mbp-0">
                <div className="row mbp-10 position-relative bgc-pantro rounded-p-5 p-2 bloque-respuesta">
                  <div className="position-absolute top-0 start-100 translate-middle"><img src="images/page_052/pareja.png" className="hp-120 msp--70 mbp-140" alt=""/></div>
                  ...
                  <div class="col-1 p-1"><div class="bgc-white p-1 h-100 d-flex align-items-center justify-content-center"><img src="images/page_052/cuadro.svg" className="wp-30" alt="" /></div></div>
                  <div class="col-2 p-1"><div class="bgc-white p-1 h-100 d-flex align-items-center justify-content-center"><img src="images/page_052/cuadro.svg" className="wp-30" alt="" /></div></div>
                  <div class="col-1 p-1"><div class="bgc-white p-1 h-100 d-flex align-items-center justify-content-center"><img src="images/page_052/cuadro.svg" className="wp-30" alt="" /></div></div>
                  ...
                  <div class="col-1 ps-1 pe-1 pb-1 ptp-2"><div class="bgc-white p-1 h-100 d-flex align-items-center justify-content-center"><img src="images/page_052/cuadro.svg" className="wp-30" alt="" /></div></div>
                  <div class="col-2 ps-1 pe-1 pb-1 ptp-2"><div class="bgc-white p-1 h-100 d-flex align-items-center justify-content-center"><img src="images/page_052/cuadro.svg" className="wp-30" alt="" /></div></div>
                  <div class="col-1 ps-1 pe-1 pb-1 ptp-2"><div class="bgc-white p-1 h-100 d-flex align-items-center justify-content-center"><img src="images/page_052/cuadro.svg" className="wp-30" alt="" /></div></div>
