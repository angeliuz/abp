...
function Page056(props) {
  ...
  return (
    <div className="wrapper bgc-light">
              ...
              <div className="page cb-page56 bgc-white overflow-hidden position-relative cb-6" id={"page_"+pagina}>
                ...
                <div className="position-relative w-100 ptp-100 psp-10 pep-10">
                            ...
                            <div className="bgc-white border-style-solid border-2 border-color-pidgey rounded-p-10">
                                <div className="bgc-guile w-70 text-start mtp--10 msp--10 rounded-p-10">
                      ...
                      <div className="row ptp-20">
                              <div className="col-md-6 ">
                                  <div className="bgc-white mpt-10 border-style-solid border-2 border-color-pidgey rounded-p-10">
                                      <div className="bgc-tshinhan w-90 text-start mtp--10 msp--10 rounded-p-10">
            ...
            <div className="f-Ubuntu-L bgc-info fsp-13 rounded-p-10  w-90">
              <div className="bgc-white rounded-p-10 pep-80 d-flex bgc-red w-90">


                    <div className=" mbp-30">
                      <div className="d-flex pep-10 justify-content-between bgc-yellow wp-300">
                      ...
                      <div className="psp-15 pep-20 f-Ubuntu-L bgc-white fsp-13 rounded-seb-10">
                        ...
                        <div className="d-flex justify-content-between ">
                          <div className="d-flex mnwp-400-r cb-contenedor-tabla-texto ">
                            <div className="flecha-saitama pep-10 mtp-8"></div> <span className="text-start f-Ubuntu-L fsp-15 ptp-5">
