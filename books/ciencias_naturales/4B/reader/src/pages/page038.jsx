          ...
          <div className="ptp-50 container-titulo-global mbp-0">
            ...
            <div className="d-flex psp-20">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                Leemos la revista y pensamos en las tres ideas que queremos
                comunicar en una ficha de seguridad.
              </div>
          ...
          <div className="ptp-50 psp-20 pep-100 mbp-0">
            ...
            <div className="d-flex psp-40">
              <img
                ...
                src={"images/page_" + pagina + "/img_002.svg"}
                alt=""
              />
              <div className={"f-ccdigitaldelivery-bold fsp-35 " + color}>
                3
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                Pensamos en la estructura de la ficha de seguridad y la
                diseñamos.
              </div>
            ...
            <div className="row p-0 m-0 w-100">
              <div className="col-12">
                <div className="d-flex justify-content-around align-items-center  w-100 pep-20 psp-20  position-relative">
                  <div className="position-absolute top-0 start-100 translate-middle   msp--30 mtp-10  ">
                    <img
                      src="images/page_038/img_004.png"
                      className="wp-60"
                      alt=""
                    />
                  </div>
                  <div className="d-flex align-items-center justify-content-center text-center bgc-genos   wp-240 hp-40 p-2 rounded-p-5  fsp-15 mep-5 ">
                    Hojas de bloc o cartulinas
                  </div>
                  <div className="d-flex align-items-center justify-content-center text-center bgc-piccolo wp-240 hp-40 p-2 rounded-p-5  fsp-15 msp-5 ">
                    Lápices de colores
                  </div>
                </div>
              </div>
