        ...
        >
          ...
          <div className="ptp-50 container-titulo-global mbp-0">
            ...
            <div className="d-flex psp-20">
              ...
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"83"} image={"images/page_" + pagina + "/img_002.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
            </div>
          </div>
