        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className={"cabecera-v2 d-flex flex-column " + background}>
            <div className="d-flex contenedor-cabecera-v2 ptp-40 psp-30 pep-30">
              ...
              <div className="d-flex align-items-center fsp-24 fw-700 f-Ubuntu-M color-white">Iniciamos la investigación</div>
            </div>
            <div className="d-flex contenedor-cabecera-v2 ptp-10 psp-0 pep-0 align-self-center justify-content-between w-95">
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-16 lh-sm text-white text-center">
              ...
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-16 lh-sm text-white text-center">
                Entender cuál es la función de los nutrientes
              </div>
              <div className="psp-5 pep-5 align-self-center">
                <img src={"images/generales/flecha_sesion_e" + etapa + "_2.svg"} className="wp-40 arrow-global" alt="" />
              </div>
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-16 lh-sm text-white text-center">
                Relacionar los alimentos con la función que cumplen en el organismo
              </div>
              <div className="p-0 align-self-center">
                <img src={"images/generales/flecha_sesion_e" + etapa + "_1.svg"} className="wp-40 arrow-global" alt="" />
              </div>
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-16 lh-sm text-white text-center">
                Diferenciar tipos de alimentos
              </div>
              <div className="p-0 align-self-center">
                <img src={"images/generales/flecha_sesion_e" + etapa + "_2.svg"} className="wp-40 arrow-global" alt="" />
              </div>
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-16 lh-sm text-white text-center">
                Reflexionar sobre la variedad, tamaño y frecuencia de las porciones recomendadas
              </div>
            </div>
          </div>
          ...
          <div className="cb-contenedor-mail text-start position-relative">
            ...
            <div className="cb-datos-mail pep-15 psp-10 ptp-10 pbp-10">
              <div className="d-flex mbp-5">
                ...
                <div className="cb-datos-1 psp-10 f-Ubuntu-R fsp-16">nutricionistas@correo.cl</div>
              </div>
              <div className="d-flex mbp-5">
                <div className="cb-datos-a psp-10 mep-10">Para:</div>
                <div className="cb-datos-1 psp-10 f-Ubuntu-R fsp-16">estudiantes_5b@correo.cl</div>
              </div>
            ...
            <div className="cb-texto-mail">
              <div className="cb-carta-content f-Ubuntu-L">
                ...
                <p>Junto con saludarles, y esperando se encuentren muy entusiasmados por iniciar la etapa de investigación de su proyecto, me presento: soy Carolina, nutricionista del Instituto de los Alimentos. Me pongo en contacto con ustedes para comentarles la importancia que tiene la nutrición para que las personas puedan mantener un estilo de vida saludable. </p>

                <p>Gracias a la alimentación, nuestro cuerpo obtiene los nutrientes y la energía que necesita a partir de los alimentos. Estos nutrientes viajan en nuestra sangre y permiten que nuestro organismo pueda realizar sus funciones vitales. Por ello, es muy importante aprender a seleccionar aquellos alimentos más adecuados para tener un buen estado nutricional, saber de qué modo cocinarlos para que nuestros platos sean buenos y saludables, y controlar las cantidades que ingerimos. </p>
                <p>Los invito a que sigan investigando sobre la alimentación saludable  y recuerden que ¡Somos lo que comemos! </p>
                <p>Un saludo afectuoso, Carolina. </p>
          ...
          <div className="d-flex global-margin mtp-0 mbp-100 psp-0 pep-0 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
              <div className="col-12 p-0 m-0 position-relative">
                <div className="position-absolute top-50 start-0 translate-middle msp-0 mtp-0 visible-768 zindex-1"><img src={"images/page_" + pagina + "/img_004.png"} className="wp-25" alt="" /></div>

                <div className="border-style-solid border-0 border-color-padme rounded-p-10">
                  <div className="d-flex flex-column bgc-bison rounded-p-10">
                    <div className="psp-20 pep-20 ptp-20 pbp-20 f-Ubuntu-L fsp-15 text-start">
                      Según la información del mail, comemos para
