...
xxx
                    ...
                    <div className="d-flex psp-60 pep-60 mtp-20 mbp-10">
                        <div className="row w-100 p-0 m-0">
                            <div className="col-12 p-0 m-0 position-relative">
                                <div className="position-absolute top-0 start-100 translate-middle  zindex-1 mep-0 msp-20  mtp-70"><img src={"images/page_" + pagina + "/img_001.png"} className="wp-60" alt="" /></div>
                                <div className="position-absolute top-100 start-0 translate-middle  zindex-1 msp-50 mtp--20"><img src={"images/page_" + pagina + "/img_002.png"} className="wp-170" alt="" /></div>
                                ...
                                <div className=" border-style-solid border-2 border-color-dark rounded-p-10 min-hp-700">
                                    <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 fsp-15 text-start flex-grow-1 lhp-35 min-hp-580" />
                                </div>
                            </div>
...
xxx
                        ...
                        <div className="d-flex psp-20">
                            ...
                            <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                                Elaboramos el afiche para promocionar el Día de la Alimentación Saludable y lo pegamos en el colegio.
                            </div>
                            {/* <img src={"images/page_"+pagina+"/img_00.svg"} className="wp-100" alt=""/> */}
                            {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/generales/play.svg"} clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
                            {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/page_"+pagina+"/img_001.png"} className="p-0 px-1" /> */}
