        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="ptp-30 container-titulo-global mbp-0">
            ...
            <div className="d-flex psp-20">
              ...
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"95"} image={"images/page_" + pagina + "/img_002.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
          ...
          <div className="d-flex global-margin mtp-0 mbp-80 psp-30 pep-0 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
              ...
              <div className="col-lg-4 col-md-6 d-inline m-0 ptp-10 pbp-10">
