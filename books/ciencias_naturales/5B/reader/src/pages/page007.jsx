          ...
          <div className={"cabecera-v2 d-flex flex-column " + background}>
            ...
            <div className="d-flex contenedor-cabecera-v2 ptp-10 psp-0 pep-0 align-self-center justify-content-between w-95">
              ...
              <div className="psp-5 pep-5 ptp-10 pbp-10 position-relative align-self-center f-colby-compres-bold fsp-17 lh-sm text-center color-dark">
                ...
                <div className="position-relative">
                  Plantear un lema   <br /> relacionado con <br />el desafío
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="cb-contenedor-mail text-start position-relative">
            ...
            <div className="cb-datos-mail pep-15 psp-10 ptp-10 pbp-10">
              <div className="d-flex mbp-5">
                ...
                <div className="cb-datos-1 psp-10 f-Ubuntu-R fsp-16">salud@correo.cl</div>
              </div>
              <div className="d-flex mbp-5">
            ...
            <div className="cb-texto-mail">
              <div className="cb-carta-content f-Ubuntu-L">
                <p>Estimados estudiantes, ¡los estamos buscando!</p>
                <p>Desde la ONG de la salud hemos elaborado un plan de acción que busca aumentar la disponibilidad de alimentos saludables que se preparan y se venden en los colegios para prevenir todas las formas de malnutrición, como la obesidad, que lamentablemente afecta a muchos estudiantes. Con esta iniciativa, queremos incentivar cambios de hábitos que permitan llevar a cabo un estilo de vida más saludable y, para ello, necesitamos de su cooperación. ¿Cómo? </p>

                <p>Les pedimos que instauren en su colegio el Día de la Alimentación Saludable como parte de la campaña “Arcoíris en tu plato”. En esta ocasión, con el fin de promover hábitos saludables en el colegio, deberán dar a conocer una propuesta de alimentación saludable.</p>
                <p>¿Qué les parece el desafío? ¿Están dispuestos a colaborar? </p>
                <p>¡Nosotros esperamos que sí! </p>
                <p>Estaremos atentos a sus respuestas. </p>
                <p>Nos despedimos cordialmente, ONG de la salud.</p>

              </div>
            </div>
          </div>

          <div className="d-flex msp-20 mep-60 mtp-0 mbp-100 psp-0 pep-0 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
              <div className="col-12 p-0 m-0 position-relative">
                <div className="position-absolute top-100 start-100 translate-middle msp--20 mtp--40 visible-768 zindex-1"><img src={"images/page_" + pagina + "/img_005.png"} className="wp-100" alt="" /></div>
                      ...
                      <div className="bgc-white">
                        <div className="d-flex flex-column">
                          <div className="psp-10 pep-10">
                            <div className="f-Ubuntu-R fsp-15 text-start">Descubrí que</div>
                ...
                <div className="d-flex global-margin mtp-0 mbp-40 psp-0 pep-0 ptp-0 pbp-0">
                  <div className="row p-0 m-0 w-100">
                    <div className="col-12 p-0 m-0 position-relative">
                      <div className="bgc-white">
                        <div className="d-flex flex-column">
                          <div className="psp-10 pep-10">
                            <div className="f-Ubuntu-R fsp-15 text-start">Me han propuesto </div>
                            <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 text-start flex-grow-1 contenedor-linea  lhp-35 min-hp-120" />
                          </div>
                        </div>
                      </div>
