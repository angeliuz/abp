                    ...
                    <div className="w-100 p-3 mtp-3 bgc-white border-style-solid border-1 border-color-obiwan sombra rounded-p-10 ">
                      ...
                      <div className="row psp-4">
                        ...
                        <div className="col-sm-6 col-md-4 p-2">
                          <div className="d-flex w-100 p-0">
                            <Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check>
                            <div className="d-flex justify-content-start align-items-center text-start f-Ubuntu-R fsp-15 psp-5"><i>Slogans</i></div>
                          </div>
                        </div>
                        ...
                        <div className="p-0 m-0">
                          ...
                          <div className="text-start p-2">Los recursos que vamos a elaborar serán...</div>
                        </div>
