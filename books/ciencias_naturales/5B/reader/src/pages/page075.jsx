                        ...
                        <div className="row p-0 m-0">
                            <div className="row mx-auto d-flex f-Ubuntu-R fsp-15 mbp-20 ">
                                ...
                                <div className="col-sm-12 col-md-6 position-relative">
                                    <div className="position-absolute top-100 start-0 translate-middle msp-10 mtp--40 visible-768 zindex-1"><img src={"images/page_" + pagina + "/img_003.png"} className="wp-20 " alt="" /></div>
                                ...
                                <div className="col-sm-12 col-md-6 position-relative">
                                    <div className="position-absolute top-0 start-100 translate-middle msp--20 mtp-40 visible-768 zindex-1"><img src={"images/page_" + pagina + "/img_002.png"} className="wp-30 " alt="" /></div>
                                    <div className="text-center w-100 border-1 border-style-solid border-color-dark rounded-p-10 mtp-10">
                                        <div className="rounded-set-6 hp-40 psp-20 ptp-15 d-flex text-start">
                            ...
                            <div class="max-wp-700 mx-auto cb-contenedor justify-content-center pe-2 ps-2 pbp-15 mbp-40">
                                <div class="cb-caja mx-auto">
                                    ...
                                    <div class="text-start bgc-pantro p-3 f-Ubuntu-L fsp-13 border-color-garou position-relative cb-outline-p75 rounded-p-10" >
                                ...
                                <div class="cb-caja mx-auto mbp-40">
                                    <div class="text-start bgc-draco p-3 c f-Ubuntu-L fsp-13 border-color-garou cb-outline-p75 rounded-p-10" >
