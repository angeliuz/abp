        ...
        >
          ...
          <div className="ptp-30 container-titulo-global mbp-10">
            ...
            <div className="d-flex">
              ...
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} pagina={"81"} image={"images/page_" + pagina + "/img_003.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
            </div>
          </div>
          ...
          <div className="d-flex msp-60 mep-60 mbp-100 mtp-60">
            ...
            <div className="row m-0 psp-10 pep-10 ptp-0 pbp-10 rounded-p-20 w-100">
              ...
              <div className="col-sm-12 col-md-6 position-relative">
              <div className="position-absolute top-100 start-100 translate-middle zindex-1 mtp--150 msp-10 visible-768"><img src="images/page_023/img_005.png" className="" alt="" /></div>
              ...
              <div className="position-absolute top-50 start-0 translate-middle zindex-1 msp--10 visible-768"><img src="images/page_023/img_006.png" className="" alt="" /></div>
