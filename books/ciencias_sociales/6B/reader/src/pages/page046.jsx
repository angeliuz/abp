                ...
                <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
                    ...
                    <div className="ptp-10 container-titulo-global-1 mbp-0">
                        ...
                        <div className="d-flex psp-0">
                            ...
                            <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">A partir de la obra que me tocó analizar, completo el siguiente esquema con el olor, la imagen, el sonido, el sabor y la textura que me transmite.</div>
