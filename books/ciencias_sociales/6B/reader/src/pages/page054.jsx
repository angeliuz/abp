        ...
        >
          ...
          <div className="ptp-10 container-titulo-global-1 mbp-0">
            ...
            <div className="d-flex psp-0">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                Con mi grupo elaboramos una breve explicación de nuestra obra.
              </div>
              ...
              <div className="col-12 p-2 m-0 position-relative">
                <div className="d-flex justify-content-center w-100">
                  <div className="bgc-draco w-100 p-2 box-shadow-simple position-relative">
                    <div className="position-absolute top-0 start-100 translate-middle msp--20 mtp-10 zindex-1">
                      <img
                        src={"images/page_" + pagina + "/pincho.svg"}
                        className="wp-30"
                        alt=""
                      />
                    </div>
                    <div className="position-absolute top-50 start-100 translate-middle msp-15 mtp--40 zindex-1">
                      <img
                        src={"images/page_" + pagina + "/circulo.png"}
                        className="wp-50"
                        alt=""
                      />
                    </div>
                    <div className="position-absolute top-50 start-0 translate-middle msp--5 mtp-0 zindex-1">
                      <img
                        src={"images/page_" + pagina + "/lapiz.png"}
                        className="hp-85"
                        alt=""
                      />
                    </div>
                    <InputBox
                      ...
                      className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-350"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="ptp-10 container-titulo-global-1 mbp-0">
            ...
            <div className="d-flex psp-0">
              <img
                className="hp-15 align-center mtp-20 me-2 mb-2"
                src={"images/page_" + pagina + "/g_i.svg"}
                alt=""
              />
              <div className={"f-ccdigitaldelivery-bold fsp-35 " + color}>
                3
              </div>
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start mep-80">
                Con mi grupo preparamos una presentación para explicar nuestra
                obra al curso en la siguiente sesión.
              </div>
              {/* <img src={"images/page_"+pagina+"/img_001.svg"} className="wp-100" alt=""/> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/generales/play.svg"} clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/page_"+pagina+"/img_001.png"} className="p-0 px-1" /> */}
          ...
          <div className={" position-relative mtp-20  border-top-style-solid  border-2 pbp-80 " + bgc_cajas}>
            <div className="position-absolute top-0 start-100 translate-middle">
              <img
                ...
                className="hp-70 msp--200 mtp--60"
                alt=""
              />
            </div>
            <div className="global-margin mtp-15 mbp-5 f-pixilate-bold fsp-18 lh-sm text-start psp-10">
              ¿Cómo voy?
            </div>
            <div className="global-margin mbp-20 psp-20 pep-20 ptp-5 pbp-5 f-Ubuntu-L bgc-white fsp-15 rounded-p-10 ">
              <div className="d-flex flex-wrap w-100 align-items-end titulo-linea mtp-10">
                <div className="d-flex">
                  <img
                    ...
                    className="mep-5 wp-15"
                    alt=""
                  />
                  <span className="w-24 f-Ubuntu-L fsp-14 text-start">
                    Mi creatividad me ha ayudado a
                  </span>
                </div>
              </div>
              ...
              <div className="d-flex flex-wrap w-100 align-items-end titulo-linea mtp-10">
                <div className="d-flex">
                  ...
                  />
                  <span className="w-24 f-Ubuntu-L fsp-14 text-start">
                    Para pensar más y mejor necesito
                  </span>
                </div>
              </div>
              <div className="pt-0 flex-grow-1 mbp-20">
            ...
            <div className="d-flex flex-column global-margin mtp-0 mbp-40 psp-0 pep-0 ptp-0 pbp-0">
              <div className="col-12">
                <div className="f-pixilate-bold fsp-18 lh-sm text-start mbp-5">
                  ¿Cómo me siento?
                </div>
                <div className="d-flex flex-wrap w-100 align-items-end titulo-linea mbp-30">
                  <div className="w-100 p-2 pb-3 bgc-white rounded-p-10">
                    <table className="w-100 text-start">
                      <span className="w-24 f-Ubuntu-L fsp-14 mtp-5 mbp-10 text-start">
                        Marco con un{" "}
                        <img
                          src={"images/page_" + pagina + "/ticket.svg"}
                          className="hp-17 mtp--2"
                          alt=""
                        />{" "}
                        el recuadro que mejor me represente.
                      </span>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td
                            className={
                              "style-caja " +
                              background +
                              " tf-letra border-style-solid border-1 " +
                              borderColor +
                              " f-colby-compres-bold ps-2 pe-2 text-white text-center"
                            }
                          >
                            Nunca
                          </td>
                        ...
                        <tr>
                          <td
                            className={
                              "" +
                              bgc_cajas +
                              " f-Ubuntu-L fsp-14 text-start psp-5 border-style-solid border-1 " +
                              borderColor +
                              ""
                            }
                          >
                            Me siento tenso y nervioso cuando trabajo con mi
                            equipo.
                          </td>
                          <td
                            className={
                              "border-style-solid border-1 " + borderColor + ""
                            }
                          >
                            <Check2
                        ...
                        <tr>
                          ...
                          >
                            Me asusta no hacer bien el trabajo y recibir
                            críticas.
                          </td>
                          <td
                            className={
