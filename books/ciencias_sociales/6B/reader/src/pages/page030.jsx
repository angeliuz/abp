                ...
                <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
                    ...
                    <div className="psp-60 pep-60">
                        ...
                        <div className="d-flex pbp-20">
                            <div className="wp-160 bgc-lavanda1 rounded-p-20 zindex-1 d-flex align-items-center justify-content-center ">
                                <span className=" p-3 f-Ubuntu-B color-white text-center  ">Deber o
                                    responsabilidad 1</span></div>
                            <div className="w-100 bgc-bobafett rounded-tbe-20 msp--20 py-2 psp-25 pep-10">
