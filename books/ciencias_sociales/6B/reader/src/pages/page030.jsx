                    ...
                    <div className="ptp-30 container-titulo-global mbp-10">
                        ...
                        <div className="d-flex">
                            ...
                            <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                                Con mi grupo, señalo con qué color, símbolo e imagen representaríamos
                                cada deber o responsabilidad que escogimos.
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="position-absolute top-0 start-100 translate-middle zindex-1 "><img src="images/page_030/img_002.png" className=" " alt="" /></div>
                                <div className="d-flex pbp-20">
                                    <div className="wp-180 bgc-lavanda1 rounded-p-20 zindex-1 d-flex align-items-center justify-content-center ">
                                        <span className=" p-3 f-Ubuntu-B color-white text-center">Deber o
                                            responsabilidad 1</span></div>
                            ...
                            <div className="position-absolute top-100 start-0 translate-middle zindex-2 "><img src="images/page_030/img_003.png" className=" " alt="" /></div>
                                <div className="d-flex pbp-20  ">
                                    <div className="wp-160 bgc-lavanda2 rounded-p-20 zindex-1 d-flex align-items-center justify-content-center ">
                            ...
                            <div className="col-6 position-relative ptp-20 pbp-20">
                                ...
                                <div className="position-absolute top-0 start-50 translate-middle mtp-20 f-Ubuntu-B wp-160 bgc-lavanda2 rounded-p-20 zindex-1 d-flex align-items-center justify-content-center color-white p-3">
                                    Símbolo
                                </div>
                            </div>
                            <div className="col-6 position-relative ptp-20 pbp-20">
