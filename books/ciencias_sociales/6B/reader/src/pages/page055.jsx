        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className={"cabecera-v2 d-flex flex-column " + background}>
            <div className="d-flex contenedor-cabecera-v2 ptp-40 psp-30 pep-30">
              ...
              <div className="d-flex align-items-center fsp-24 fw-700 f-Ubuntu-M color-white">Corregimos el diseño de nuestra obra</div>
            </div>
            <div className="d-flex contenedor-cabecera-v2 ptp-10 psp-30 pep-30 align-self-center justify-content-between w-95">
              ...
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-17 lh-sm text-white text-center">
                Presentar el primer <br /> diseño de nuestra obra de arte.
              </div>
              <div className="psp-5 pep-5 align-self-center">
                <img src={"images/generales/flecha_sesion_e" + etapa + "_2.svg"} className="wp-40 arrow-global" alt="" />
              </div>
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-17 lh-sm text-white text-center">
                Recoger los comentarios sobre el <br /> diseño de nuestra obra de arte.
              </div>
              <div className="p-0 align-self-center">
                <img src={"images/generales/flecha_sesion_e" + etapa + "_1.svg"} className="wp-40 arrow-global" alt="" />
              </div>
              <div className="psp-5 pep-5 align-self-center f-colby-compres-bold fsp-17 lh-sm text-white text-center">
                Corregir el diseño <br /> de nuestra obra de arte.
              </div>
            </div>
          </div>
          ...
          <div className="ptp-10 container-titulo-global-1 mbp-0">
            ...
            <div className="d-flex psp-0">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start mep-150">Explicamos el diseño de nuestra obra de arte al curso. Recogemos los comentarios que realizan a partir de la pregunta planteada.</div>
          ...
          <div className="d-flex global-margin mtp-0 mbp-0 psp-0 pep-0 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
              <div className="col-12 ptp-10 pbp-10 psp-30 pep-30 m-0 position-relative bgc-hansolo rounded-p-10">
                <div className="d-flex justify-content-center">
                  <div className="bgc-white w-100 p-2 position-relative border-style-solid border-color-pidgey border-1 rounded-p-10">
                    <div className="position-absolute top-0 start-100 translate-middle msp--70 mtp--40 zindex-1"><img src={"images/page_" + pagina + "/mono.png"} className="hp-90" alt="" /></div>
                    <div className="f-Ubuntu-R fsp-14 lh-sm text-central ptp-10">¿El diseño de la obra transmite lo que el grupo desea expresar?</div>
          ...
          <div className="ptp-10 container-titulo-global-1 mbp-0">
            ...
            <div className="d-flex psp-0">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">En grupo, decidimos realizar los siguientes cambios.</div>
              {/* <img src={"images/page_"+pagina+"/img_001.svg"} className="wp-100" alt=""/> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/generales/play.svg"} clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image={"images/page_"+pagina+"/img_001.png"} className="p-0 px-1" /> */}
              {/* <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} image={"images/page_" + pagina + "/revista.svg"} clasesImagen="hp-35 text-center mtp-10 " className="p-0 px-0" /> */}
          ...
          <div className="d-flex global-margin mtp-0 mbp-0 psp-20 pep-0 ptp-0 pbp-0">
            <div className="row p-0 m-0 w-100">
