                  ...
                  <div className="d-flex flex-column position-relative w-100">
                    ...
                    <div className="row d-flex f-Ubuntu-R fsp-15 mbp-20 ">
                      <div className="position-relative">
                        <div className="position-absolute top-100 start-100 translate-middle msp--40 mtp-130 visible-768 zindex-1"><img src={"images/page_" + pagina + "/img_007.png"} className="wp-120" alt="" /></div>
                      </div>
