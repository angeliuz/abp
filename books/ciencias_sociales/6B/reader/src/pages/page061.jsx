        ...
        >
          ...
          <div className={"cabecera-v2 " + background + " d-flex flex-column"}>
            <div className="d-flex contenedor-cabecera-v2 ptp-40 psp-30 pep-30">
              <div className="caja-seccion wp-160 hp-70 text-center fsp-24 f-IntroRustG-Base color-dark">
                SESIÓN 15
              </div>
            ...
            <div className="d-flex contenedor-cabecera-v2 ptp-10 psp-30 pep-30 align-self-center justify-content-between w-90">
              ...
              <div className="p-0 align-self-center">
                <img
                  ...
                  className="wp-40 arrow-global rotate-90"
                  alt=""
                />
              </div>
              <div className="p-2 align-self-center f-colby-compres-bold fsp-15 lh-sm text-white text-center">
              ...
              <div className="p-3 align-self-center f-colby-compres-bold fsp-15 lh-sm text-center text-white">
                ...
                <br />
                elaboración de la obra de arte.
              </div>
            </div>
          </div>
          ...
          <div className="ptp-10 container-titulo-global mbp-0">
            ...
            <div className="d-flex psp-20">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                Establecemos qué tareas básicas son necesarias para elaborar la
                obra de arte. Indicamos qué integrante del grupo será
