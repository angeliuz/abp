        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_"+pagina}>
          ...
          <div className="d-flex msp-60 mep-60 mbp-100">
            ...
            <div className="row m-0 p-2 bgc-azuka rounded-p-20 w-100">
                ...
                <div className="col-md-12 col-lg-12 position-relative">
                  <div className="position-absolute top-0 start-100 translate-middle msp-0 mtp-20 visible-768"><img src="images/page_041/img_002.png" className="wp-50 " alt="" /></div> 
                ...
                <div className="col-md-12 col-lg-12 position-relative">
                    <div className="position-absolute top-100 start-100 translate-middle msp--10 mtp--40 visible-768"><img src="images/page_041/img_004.png" className="wp-75 " alt="" /></div>
                    <div className="position-absolute top-100 start-0 translate-middle msp-0 mtp--40 visible-768"><img src="images/page_041/img_003.png" className="wp-80 " alt="" /></div>
