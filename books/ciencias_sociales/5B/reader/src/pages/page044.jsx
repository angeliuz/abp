                        ...
                        <div className="row m-0 p-2 w-100 ">
                            ...
                            <div className=" col-sm-12 col-md-6 position-relative align-items-stretch mbp-30">
                                ...
                                <div className="h-100 d-flex flex-column mbp-20 mtp-10 p-2 w-100 border-style-solid border-2 rounded-p-10 border-color-dark bgc-white">
                                    <div className="h-100 p-2 w-100 ">
                                        <div className="f-Ubuntu-L fsp-16  text-start w-100">Nos gustaria saber más sobre...</div>
                                        <div className="h-100 pep-20">
                                            <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="h-95 p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-210  " />
                                        </div>
                                    </div>
                                </div>
                            </div>
