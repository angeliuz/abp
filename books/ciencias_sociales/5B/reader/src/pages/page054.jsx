            ...
            <div className="row w-100 p-0 m-0">
              ...
              <div className="col-12">
                ...
                <div className="d-flex flex-wrap w-100 align-items-end titulo-linea mbp-30">
                  <span className="w-24 f-Ubuntu-L mtp-5 mbp-10 fsp-14">Marco con un <img src="images/page_054/img_006.svg" className="hp-17 mtp--2" alt="" /> el recuadro que mejor me represente.</span>
                  <div className="w-100 p-2 pb-3 bgc-white rounded-p-10">
                    <table className="w-100">
                      <tbody>
                        ...
                        <tr>
                          <td className="bgc-bison f-Ubuntu-L fsp-14 text-start psp-5 border-style-solid border-1 border-color-pidgey">Me siento tenso y nervioso cuando trabajo con mi equipo.</td>
                        ...
                        <tr>
                          <td className="bgc-bison f-Ubuntu-L fsp-14 text-start psp-5 border-style-solid border-1 border-color-pidgey">Me asusta no hacer bien el trabajo y recibir críticas.</td>
                          <td className="border-style-solid border-1 border-color-pidgey"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check></td>
                          <td className="border-style-solid border-1 border-color-pidgey"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check></td>
                          <td className="border-style-solid border-1 border-color-pidgey"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check></td>
                          <td className="border-style-solid border-1 border-color-pidgey"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check></td>
