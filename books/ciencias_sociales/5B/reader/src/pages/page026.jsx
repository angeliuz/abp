        ...
        >
          ...
          <div className="ptp-10 container-titulo-global mbp-0">
            <div className="d-flex">
              <img
                ...
                src="images/page_026/img_002.svg"
                alt=""
              />
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                Comparto mi diseño con mi grupo y lo comentamos. Luego,
                diseñamos el afiche que incluiremos en la revista. Dibujo el
                boceto en el siguiente espacio:
              </div>
            </div>
          </div>
          ...
          <div className="row container-row">
            <div className="col-md-12 col-lg-12 position-relative">
              <div className="position-absolute top-50 start-100 translate-middle visible-768 zindex-1 msp--70 mtp-150">
                <img
