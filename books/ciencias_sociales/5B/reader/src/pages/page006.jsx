              ...
              <div className="cb-lineas pbp-60">
                <div className="cb-cabecera">
                  ...
                  <div className="cb-cohete">
                    <img src={process.env.PUBLIC_URL + "images/page_006/img_001.png"} alt="s" />
                  </div>
                </div>
                <div className="cb-contenedor-1 d-flex justify-content-end">
                  <div className="color-hardDark fsp-16 lh-sm f-pixilate-regular text-start">
                    <div className="d-flex bgc-piccolo psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 cb-outline">
                      <div className="d-flex">
                        <img src={process.env.PUBLIC_URL + "images/page_006/arrow.svg"} className="mbp-20 mep-5" alt="s" />
                      </div>
                      <div>
                        <span className="fsp-16 f-IntroRustG-Base">COMPRENDER</span>
                ...
                <div className="cb-contenedor-2">
                  <div className="color-hardDark fsp-16 lh-sm f-pixilate-regular text-star">
                    <div className="d-flex bgc-piccolo psp-20 ptp-20 pbp-15 pep-20 rounded-p-10 cb-outline">
                      ...
                      <div>
                        <span className="fsp-16 f-IntroRustG-Base">COMPROMETERME</span>
                        <br /> con el desafío.
                      </div>
                    </div>
                  </div>
