            ...
            <div className="wrapper bgc-light">
                    <div className="d-flex flex-column align-items-center pbp-20">
                        ...
                        <div className="page bgc-goten position-relative" id="page_006">
                            ...
                            <div className="cb-cohete" ><img src={process.env.PUBLIC_URL + "images/page_006/img_001.png"} alt="" />
                            </div>
                        </div>
                            ...
                            <div className="color-hardDark fsp-16 lh-sm f-pixilate-regular text-start">
                                ...
                                <div className="d-flex"> <img src={process.env.PUBLIC_URL + "images/page_006/arrow.svg"} className="mbp-20 mep-5" alt="" /></div>  
