        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="ptp-10 container-titulo-global mbp-20">
            <div className="d-flex">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">Leo los grupos propuestos y pienso en cuáles me gustaría investigar. Luego, asignamos uno a cada integrante del equipo. Marco con un <img src="images/page_033/img_005.svg" className="hp-17 mtp--2" alt="" /> el grupo que me corresponde investigar.</div>
          ...
          <div className="row mx-4 position-relative">
            ...
            <div className="col-sm-12 col-md-6 position-relative">
              ...
              <div className="position-absolute top-50 start-100 translate-middle zindex-1 border-style-solid border-1 border-color-dark msp--30 mtp--30"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg"></Check></div>
              ...
              <div className="mbp-20 mtp-10 px-3">
                <div className="position-relative d-flex flex-column align-items-center justify-content-center bgc-honda min-hp-130 p-2 rounded-p-10 w-100">
                  ...
                  <div className="w-100 bgc-white rounded-p-10 p-2">
                    <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-35 w-100 bgc-white" />
                  </div>
                </div>
              </div>
            </div>
