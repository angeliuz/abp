        ...
        >
          ...
          <div className="ptp-10 container-titulo-global mbp-20">
            <div className="d-flex">
              ...
              <div className="f-ccdigitaldelivery-bold fsp-35 color-pidgey">
                2
              </div>
          ...
          <div className="ptp-10 msp-15 mep-50 mbp-20">
            <div className="d-flex">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                En grupo decidimos cómo serán las páginas de nuestra entrevista.
                Luego, dibujo un boceto de ellas que indique cómo
                diferenciaremos cada sección.
              </div>
              {/* <ModalBook id={ "p" + pagina + "_book"+ (indexInput+=1) } image="images/page_031/img_002.svg" clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" /> */}
            </div>
          </div>
          ...
          <div className="d-flex psp-60 pep-60 pbp-100">
            <div className="row w-100 bgc-zangief psp-10 pep-10 ptp-20 pbp-20 rounded-p-20">
              <div className="col-sm-12 col-md-6 ">
                <div className="d-flex bgc-white center-center p-2 border-style-solid border-2 border-color-cyrax min-hp-400">
                  <SubirImagen
              ...
              <div className="col-sm-12 col-md-6 position-relative">
                <div className="position-absolute top-0 start-100 translate-middle wp-100 msp-40 mtp-50">
                  <img
                    src="images/page_050/lapiz.png"
                    className="wp-15 mep-70 mtp-30"
                    alt=""
                  />
                </div>
                <div className="d-flex bgc-white center-center p-2 border-style-solid border-2 border-color-cyrax min-hp-400">
