          ...
          <div className="row container-row px-5">
            <div className="col-sm-12 col-md-6 position-relative">
              ...
              <div className="box-color-24-1">
                <div className="f-Ubuntu-B alinea rounded-set-10 bgc-akuma w-100 p-2 text-center color-white">¿En qué se parece a la entrevista que observé en la actividad anterior?</div>
            ...
            <div className="col-sm-12 col-md-6 position-relative">
              ...
              <div className="box-color-24-2">
                <div className="f-Ubuntu-B alinea rounded-set-10 bgc-bulma w-100 p-2 text-center color-white">¿En qué se diferencia de la entrevista que observé en la actividad anterior?</div>
