        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="row container-row">
            ...
            <div className="col-md-12 col-lg-12 position-relative">
              ...
              <div className="position-absolute top-50 start-50 translate-middle mtp-280 cajaafiche-1 rounded-p-10 border-style-solid border-2 border-color-dark bgc-windu text-start p-2 zindex-2" style={{ width: "270px", marginLeft: "230px" }}>
