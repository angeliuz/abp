          ...
          <div className="ptp-10 psp-85 pe-6">
            <div className="d-flex">
              ...
              <div className="pep-10 psp-15 ptp-10">
                ...
                <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} pagina={"14"} image={"images/page_" + pagina + "/img_003.svg"} clasesImagen="cambio hp-40 text-center mtp-0 psp-10 pep-40" className="p-0 px-1" />
              </div>
            </div>
          </div>
