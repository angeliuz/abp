        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="cabecera-v2 bgc-pidgey d-flex flex-column">
            <div className="d-flex contenedor-cabecera-v2 ptp-40 psp-30 pep-30">
              <div className="caja-seccion wp-160 hp-70 text-center fsp-24 f-IntroRustG-Base">SESIÓN 13</div>
              <div className="d-flex align-items-center fsp-24 fw-700 f-Ubuntu-M color-white">¿Qué aprendimos en las entrevistas?</div>
            </div>
            ...
            <div className="row w-100 f-Ubuntu-L fsp-14 rounded-p-20">
              <div className="col-12 ptp-10 pbp-20 d-flex justify-content-center position-relative">
                ...
                <div className="d-flex flex-column wp-360 ptp-30 pbp-30 bgc-hermione rounded-p-20 position-relative">
                  ...
                  <div className="position-absolute top-50 start-100 translate-middle zindex-1"><img src="images/page_053/img_005.png" className="wp-60" /></div>
              ...
              <div className="col-12 ptp-10 pbp-20 d-flex justify-content-center position-relative">
                ...
                <div className="d-flex flex-column wp-360 ptp-30 pbp-30 bgc-azuka rounded-p-20 position-relative">
                  ...
                  <div className="position-absolute top-100 start-0 translate-middle zindex-1"><img src="images/page_053/img_008.png" className="wp-70" /></div>
