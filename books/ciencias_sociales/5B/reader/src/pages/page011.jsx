  ...
  return (
    <div className="wrapper bgc-light">
      <div className="d-flex flex-column align-items-center pbp-20">
          <div className="page position-relative soc-page11" id="page_011">
              <div className="mep-0 position-absolute top-0 end-0">
                  <div className="d-flex justify-content-start bgc-misty color-bulma ptp-55 pb-2 px-3 text-center mep-55 rounded-seb-20 lh-1">
