                ...
                <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
                    ...
                    <div className="ptp-10 container-titulo-global mbp-0">
                        <div className="d-flex">
                            <img className="hp-20 align-center mt-3 me-2 mb-2" src="images/page_025/img_002.svg" alt="" />
                            ...
                            <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} pagina={"25"} image={"images/page_" + pagina + "/img_005.svg"} clasesImagen="hp-40 text-center mtp-15 msp--10" className="p-0 px-0" />
                        </div>
                    </div>
                    ...
                    <div className="row container-row">
                        ...
                        <div className="col-md-12 col-lg-12 position-relative">
                            ...
                            <div className="position-absolute top-50 start-0 translate-middle visible-768 zindex-1 msp-70 mtp--5"><img src="images/page_025/img_004.png" className="w-100" alt="" /></div>
                            <div className="position-absolute top-100 start-0 translate-middle visible-768 zindex-1 msp-100 mtp--90"><img src="images/page_025/img_005.png" className="w-100" alt="" /></div>
                        ...
                        <div className="col-md-12 col-lg-12 mbp-70">
                            <div className="psp-60 pep-60">
                                <div className="cajaafiche-2 rounded-p-10 border-style-solid border-2 border-color-dark bgc-azuka text-start">
                                    <div className="psp-10 f-Ubuntu-R fsp-16 ptp-10 pbp-10">Caracteristícas de un afiche:</div>
