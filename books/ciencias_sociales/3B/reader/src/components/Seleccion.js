...
const Seleccion = (props) => {
    ...
    return <div>
        ...
        <div className={props.classNameContenedor} onClick={handleClick}>
            <div className=" disable-select">{props.texto}</div>
            <div className={props.classNameImagen}>
                <img src={image} className={(visible === false ? "oculto" : "visible") + " disable-select w-100 h-100"} alt="" />
            </div>
