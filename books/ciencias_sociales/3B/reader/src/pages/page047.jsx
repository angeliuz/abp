          ...
          <div className="page bgc-white overflow-hidden position-relative" id={"page_"+pagina}>
            ...
            <div className="ptp-10 psp-60 mbp-0 contenedor-pagina">
              ...
              <div className="d-flex justify-content-center msp-60 mep-40">
                ...
                <div className="position-relative"> <img className="hp-280 " src="images/page_047/img_002.png" alt="" /> 
                    <div className="position-absolute top-50 start-50 translate-middle w-100">
                        <div className="msp-40 mep-20">
                            <div className=" linea1 min-hp-100  ">
                                <div className="f-Ubuntu-L fsp-15 p-1 text-start">El texto que más me gustó fue…</div>
                                <InputBox id={ "p" + pagina + "_input"+ (indexInput+=1) } className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-100" />
                            </div>
                            <div className=" linea1 min-hp-100   ">
                                <div className="f-Ubuntu-L fsp-15 p-1 text-start">Porque…</div>
                                <InputBox id={ "p" + pagina + "_input"+ (indexInput+=1) } className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-100" />
                            </div>
                        </div>
                    </div>
