          ...
          <div className="page bgc-white overflow-hidden position-relative" id={"page_"+pagina}>
            ...
            <div className="ptp-10 psp-60 mbp-0 contenedor-pagina">
              ...
              {/* <img className="hp-20 align-center mt-3 me-2 mb-2" src="images/page_033/g_i.svg" alt="" /> */}
                ...
                <ModalBook id={ "p" + pagina + "_book"+ (indexInput+=1) } image="images/page_049/img_001.svg" clasesImagen="hp-40 msp-30 text-center mtp-10 " className="p-0 px-0" />
                ...
                <div className="d-flex justify-content-center   msp-60 mep-40">
                     <div className="row w-100 d-flex justify-content-center ">
                          ...
                          <div className="col-lg-8  col-sm-12 d-flex justify-content-center position-relative  ">
