          ...
          <div className="" style={{ paddingLeft: "6%", paddingRight: "6%" }}>
            <div className="d-flex mtp-30">
              ...
              <div className="cb-ejercicio-1-p56 ptp-20 psp-25 pbp-15 pep-10 position-relative mbp-10">
                ...
                <div className="position-absolute top-0 start-100 translate-middle msp--30 mtp-0 visible-768 zindex-1"><img src={"images/page_" + pagina + "/clip.png"} className="wp-30" alt="" /></div>
              </div>
            </div>
