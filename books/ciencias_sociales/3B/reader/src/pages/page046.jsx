...
function Page046(props) {
  ...
  return (
    ...
    <div className="wrapper bgc-light">
            ...
            <div className="mbp-50 h-100">
                    <div className="bgc-bobafett linea-separa-creacion   pbp-60">
                        ...
                        <div className="d-flex contenedor mtp-20">
                          ...
                          <div className="text-center f-pixilate-bold fsp-13 wp-60">Nunca</div>
                          <div className="text-center f-pixilate-bold fsp-13 wp-60">A veces</div>
                          <div className="text-center f-pixilate-bold fsp-13 wp-75">Generalmente</div>
                          <div className="text-center f-pixilate-bold fsp-13 wp-60">Siempre</div>
                        </div>
                        ...
                        <div className="contenedor pt-2 pb-2 f-Ubuntu-L bgc-white fsp-13 rounded-p-10"> 
                            ...
                            <div className="d-flex w-100 titulo-linea mbp-10">
                                <div className="flex-fill d-flex w-auto msp-10 align-items-center"><img src="images/page_046/img_006.svg" className="mep-5 hp-15" alt="" /><span className="f-Ubuntu-L fsp-14 text-start">Confío en mi capacidad para aprender y me valoro.</span></div>
                            ...
                            <div className="d-flex w-100 titulo-linea linea-separa-creacion-int ptp-10">
                                <div className="flex-fill d-flex w-auto msp-10 align-items-center"><img src="images/page_046/img_006.svg" className="mep-5 hp-15" alt="" /><span className="f-Ubuntu-L fsp-14 text-start"> Confío en mis compañeros y me ayudan cuandolo necesito.</span></div>
                                <div className="wp-60"><img src="images/page_036/cuadro.svg" alt="" className="wp-30" /></div>
                                <div className="wp-60"><img src="images/page_036/cuadro.svg" alt="" className="wp-30" /></div>
                                <div className="wp-75"><img src="images/page_036/cuadro.svg" alt="" className="wp-30" /></div>
                                <div className="wp-60"><img src="images/page_036/cuadro.svg" alt="" className="wp-30" /></div>
