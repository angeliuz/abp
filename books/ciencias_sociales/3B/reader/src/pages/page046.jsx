                  ...
                  <div className="row w-100 d-flex justify-content-center position-relative">
                    <div className="col-5 d-flex h-100  ">
                      <div className="d-flex">
                        ...
                        <div className="f-Ubuntu-R fsp-16 text-start ptp-18 psp-10">Algunas expresiones gastronómicas o culinarias que queremos considerar en nuestra fiesta son…</div>
