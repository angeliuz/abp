    ...
    <div className="wrapper bgc-light">
      <div className="d-flex flex-column align-items-center pbp-20">
        <div className={"dosier-e" + etapa + " page bgc-white overflow-hidden position-relative"} id={"page_" + pagina}>
          ...
          {/* BEGIN TABLE */}
          <div className="global-margin mbp-100 psp-0 pep-0 ptp-10 pbp-10  f-Ubuntu-L fsp-15 rounded-p-10 ">

            <div className="d-flex flex-wrap w-100 align-items-end titulo-linea mbp-0 position-relative">
              ...
              <div className="w-100 pep-90-p18 position-relative">
              ...
              <div className="position-absolute top-50 start-100 translate-middle msp--30 mtp-0 visible-768 zindex-1"><img src={"images/page_" + pagina + "/img_004T.png"} className="wp-110" alt="" /></div>
            </div>
