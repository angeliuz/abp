        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="ptp-30 container-titulo-global mbp-40">
            ...
            <div className="d-flex">
              ...
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"72"} image={"images/page_" + pagina + "/img_001.svg"} clasesImagen="hp-40 text-center mtp-10" className="p-0 px-0" />
                      </div>
          </div>
          ...
          <div className="ptp-5 psp-60 pep-60">
            <div className="f-Ubuntu-L text-start fsp-17 lh-sm ">Junto con la información que recopilamos en las etapas anteriores para presentar en nuestra fiesta, montaremos un <i> stand</i> cultural.</div>
          </div>
          ...
          <div className="ptp-0 container-titulo-global mbp-0">
            ...
            <div className="d-flex">
              ...
              <div className="f-Ubuntu-R fsp-16 ptp-18 psp-10 pep-10 text-start">
                Nuestro <i> stand</i> de la fiesta tendrá...
              </div>
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/generales/play.svg" clasesImagen="cambio hp-40 mtp-10" className="p-0 px-1" /> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
              {/* <ModalVideo id={ "p" + pagina + "_video"+ (indexInput+=1) } image="images/page_007/img_001.png" className="p-0 px-1" /> */}
              ...
              <div className="w-100 d-flex justify-content-end mbp-70">
                <div className="mt-2 border-style-solid border-2 border-color-goku bgc-jugador001 p-2 min-hp-340 wp-450 position-relative">
                  ...
                  <div className="d-flex align-items-start  p-1 w-100 mbp-10 ">
                    <div className="d-inline wp-35 hp-30 bgc-white"><Check id={"check" + pagina + "_" + (indexInput += 1)} image="images/generales/ticket.svg" ></Check></div>
