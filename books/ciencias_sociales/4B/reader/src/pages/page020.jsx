                ...
                <div className={"dosier-e" + etapa + " page bgc-white overflow-hidden position-relative"} id={"page_" + pagina}>
                        ...
                        <div className="row w-100 position-relative">
                            <div className="col-md-6 col-12 pbp-20 ptp-20">
                                <div className="bgc-pantro border-style-solid border-color-pidgey border-1">
                                    ...
                                    <div className="text-start psp-20 ptp-10 pep-10">
                                        <InputBox
                                            id={"p" + pagina + "_input" + (indexInput += 1)}
                                            className="p-0 px-1 flex-grow-1 lhp-25 min-hp-100 mtp--10"
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="psp-70 pep-60 position-relative">
                        <div className="row bgc-color-papel border-style-solid border-color-papel border-1 psp-30 ">
                            ...
                            <div className="col-md-6 text-left ptp-15 text-start">
                                <div className="d-flex">
                                    <div className="ptp-5 f-pixilate-bold color-goten fsp-18">
                                        Materiales
                                    </div>
                    ...
                    {/* BEGIN TABLE */}
                    <div className="global-margin mbp-50 psp-0 pep-100-768 ptp-20 pbp-20  f-Ubuntu-L fsp-13 rounded-p-10 position-relative">
