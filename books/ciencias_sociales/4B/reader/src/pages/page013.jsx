        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className={"cabecera-v2 d-flex flex-column " + background}>
            <div className="d-flex contenedor-cabecera-v2 ptp-40 psp-30 pep-30">
              <div className={"caja-seccion wp-160 hp-60 d-flex justify-content-center ptp-10 mtp-5 fsp-24 f-IntroRustG-Base " + color}>SESIÓN 2</div>
          ...
          <div className="container-titulo-global mbp-0">
            ...
            <div className="d-flex psp-20">
              ...
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} colorUnidad={background} pagina={"75"} image={"images/page_" + pagina + "/revista75-76.svg"} clasesImagen="hp-40 text-center mtp-10" className="p-0 px-0" />
