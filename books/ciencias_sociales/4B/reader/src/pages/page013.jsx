        ...
        <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
          ...
          <div className="container-titulo-global mbp-0">
            ...
            <div className="d-flex psp-20">
              ...
              <ModalBook id={"p" + pagina + "_book" + (indexInput += 1)} pagina={"76"} image={"images/page_" + pagina + "/revista75-76.svg"} clasesImagen="hp-40 text-center mtp-10 " className="p-0 px-0" />
