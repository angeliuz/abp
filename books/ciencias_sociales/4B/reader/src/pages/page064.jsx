        ...
        <div className={"dosier-e" + etapa + " page bgc-white overflow-hidden position-relative"} id={"page_" + pagina}>
          ...
          <div className="d-flex flex-column global-margin mtp-0 mbp-40 psp-0 pep-0 ptp-0 pbp-0">
            <div className="row hp-130  mbp-0">
              ...
              <div className="col-6">
                <div className=" ptp-0 w-90 position-relative align-bottom ">
              ...
              <div className="col-6  positon-relative mtp-40 ">

                <div className="d-flex justify-content-center mtp-70 align-items-center  position-absolute top-50 end-0 translate-middle-y">
                  <div className=" positon-relative   msp--100 mtp--150 mep-20 pb-2  "> <img src={"images/page_" + pagina + "/img_008.png"} className="wp-350 hp-160" alt="" />
                    <div className="position-absolute top-100 start-0 translate-middle mtp--30 msp--150    "> <img src={"images/page_" + pagina + "/img_007.svg"} className="wp-50 hp-50 " alt="" /></div>


                    <div className="position-absolute top-50 start-50 translate-middle  wp-360 mtp--80 msp--65  ">

                      <div className="d-flex flex-column gira-2 ptp-10  ">
