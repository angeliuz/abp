    ...
    <div className="wrapper bgc-light">
          ...
          <div className="row container-row px-5">
                <div className="col-sm-12 col-md-6 position-relative">
                  <div className="position-absolute top-100 start-0 translate-middle wp-100 msp-40 mtp--70"><img src="images/page_050/carta.png" className="wp-50 mep-70 mtp-30" alt="" /></div>
                    ...
                    <div className="box-color-24-1">
                        <div className="f-Ubuntu-B alinea rounded-set-10 bgc-akuma w-100 p-2 text-center color-white">¿Qué ejemplo o caso de<br /> discriminación conoces?</div>
                        <div className=" linea1 bgc-white hp-250 p-2 rounded-seb-20 border-style-solid border-color-akuma border-2">
                ...
                <div className="col-sm-12 col-md-6 position-relative">
                    ...
                    <div className="f-Ubuntu-B alinea rounded-set-10 bgc-bulma w-100 p-2 text-center color-white">¿Por qué condición o característica<br /> se discriminó en dicho caso?</div>
