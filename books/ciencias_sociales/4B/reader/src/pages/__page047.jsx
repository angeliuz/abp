                ...
                <div className="page bgc-white overflow-hidden position-relative" id={"page_" + pagina}>
                    ...
                    <div className="ptp-10 psp-70 pep-60 mbp-0 position-relative">
                        <div className="row justify-content-center">
                            <div className="col-11 p-1 m-0 position-relative">
                                ...
                                <div className="rounded-p-10 bgc-white border-style-solid border-color-ken border-1">
                                    <div className="f-Ubuntu-R fsp-14 p-2 bgc-kai rounded-ts-be-10 lh-sm min-hp-45 d-flex align-items-center justify-content-start text-start wp-290">¿Qué desafíos de convivencia escolar<br />presentan cada uno de los integrantes?</div>
                            ...
                            <div className="col-12 p-1 m-0 position-relative">
                                <div className="rounded-p-10 bgc-white border-style-solid border-color-android18 border-2">
                                    <div className="f-Ubuntu-B fsp-14 p-1 bgc-android18 rounded-set-10 text-white lh-sm min-hp-45 d-flex align-items-center justify-content-center">¿La buena convivencia requiere de esfuerzo y aprendizaje? ¿Por qué?</div>
                                    <InputBox id={"p" + pagina + "_input" + (indexInput += 1)} className="p-0 px-1 text-start flex-grow-1 contenedor-linea lhp-35 min-hp-150 mep-10 msp-10" />
                                </div>
                            </div>
                        </div>
